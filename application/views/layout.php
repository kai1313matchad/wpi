...
<head>
    ...
    <!-- Flaticon CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/flaticon.min.css">
    <!-- Slick Slider CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/plugins/slick.min.css">
    <!-- CSS Animation CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/plugins/cssanimation.min.css">
    <!-- Justified Gallery CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/plugins/justifiedGallery.min.css">
    <!-- Light Gallery CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/css/plugins/light-gallery.min.css">
...
<body>
    ...
    <div class="hero-slider-area space__bottom--r120">
        <div class="hero-slick-slider-wrapper">
            <div class="single-hero-slider single-hero-slider--background single-hero-slider--overlay position-relative bg-img" data-bg="<?php echo base_url() ?>assets/img/hero-slider/hero-slider-5.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- hero slider content -->
            ...
            <div class="single-hero-slider single-hero-slider--background single-hero-slider--overlay position-relative bg-img" data-bg="<?php echo base_url() ?>assets/img/hero-slider/hero-slider-7.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- hero slider content -->
            ...
            <div class="row align-items-center row-25">
                <div class="col-md-6">
                    <div class="about-image space__bottom__lm--30">
                        <img src="<?php echo base_url() ?>assets/img/about/about-section-1.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-5">
                    ...
                    <div class="service-banner space__bottom__md--40 space__bottom__lm--40">
                        <img src="<?php echo base_url() ?>assets/img/service/service-man-1.png" class="float-none float-lg-right" alt="">
                    </div>
                </div>
                    ...
                    <div class="row service-slider-wrapper space__bottom__md--40 space__bottom__lm--40">
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?php echo base_url() ?>assets/img/service/service-1.jpg" class="img-fluid" alt=""></a>
                            </div>
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?php echo base_url() ?>assets/img/service/service-2.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?php echo base_url() ?>assets/img/service/service-3.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?php echo base_url() ?>assets/img/service/service-4.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?php echo base_url() ?>assets/img/service/service-5.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?php echo base_url() ?>assets/img/service/service-6.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
    ...
    <div class="fun-fact-area space__bottom--r120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <!-- fun fact wrapper -->
                    <div class="fun-fact-wrapper fun-fact-wrapper-bg bg-img" data-bg="<?php echo base_url() ?>assets/img/backgrounds/funfact-bg.jpg">
                        <div class="fun-fact-inner background-color--default-overlay background-repeat--x-bottom space__inner--y30 bg-img" data-bg="<?php echo base_url() ?>assets/img/icons/ruler-black.png">
        ...
        <div class="project-wrapper space__bottom--m5" id="project-justify-wrapper">
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?php echo base_url() ?>assets/img/projects/project1.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Western Shopping Mall</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?php echo base_url() ?>assets/img/projects/project2.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">City Flyover</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?php echo base_url() ?>assets/img/projects/project3.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Highway Carpeting</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?php echo base_url() ?>assets/img/projects/project4.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">House Infrustructure Making</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?php echo base_url() ?>assets/img/projects/project5.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Wooden House</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?php echo base_url() ?>assets/img/projects/project6.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Road Repairing</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?php echo base_url() ?>assets/img/projects/project7.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Apartment Building</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?php echo base_url() ?>assets/img/projects/project8.jpg" class="img-fluid" alt="">
                    ...
                    <div class="team-slider-wrapper row">
                        <div class="single-team-member col text-center">
                            <div class="single-team-member__image space__bottom--10">
                                <img src="<?php echo base_url() ?>assets/img/team/team-member1.jpg" alt="">
                            </div>
                        ...
                        <div class="single-team-member col text-center">
                            <div class="single-team-member__image space__bottom--10">
                                <img src="<?php echo base_url() ?>assets/img/team/team-member5.jpg" alt="">
                            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 space__bottom__md--40 space__bottom__lm--40">
                    <!-- cta block -->
                    <div class="cta-block cta-block--shadow cta-block--bg bg-img" data-bg="<?php echo base_url() ?>assets/img/backgrounds/cta-bg.jpg">
                        ...
                        <div class="row">
                                ...
                                <div class="single-blog-grid space__bottom--40">
                                    <div class="single-blog-grid__image space__bottom--15">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="<?php echo base_url() ?>assets/img/blog/grid1.jpg" class="img-fluid" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="single-blog-grid space__bottom--40">
                                    <div class="single-blog-grid__image space__bottom--15">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="<?php echo base_url() ?>assets/img/blog/grid2.jpg" class="img-fluid" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="single-blog-grid space__bottom--40">
                                    <div class="single-blog-grid__image space__bottom--15">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="<?php echo base_url() ?>assets/img/blog/grid3.jpg" class="img-fluid" alt="">
                                        </a>
                                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="brand-logo-wrapper">
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?php echo base_url() ?>assets/img/brand-logo/logo1.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?php echo base_url() ?>assets/img/brand-logo/logo2.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?php echo base_url() ?>assets/img/brand-logo/logo3.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?php echo base_url() ?>assets/img/brand-logo/logo4.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?php echo base_url() ?>assets/img/brand-logo/logo5.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?php echo base_url() ?>assets/img/brand-logo/logo4.png" class="img-fluid" alt=""></a>
                        </div>
    ...
    <!--====================  newsletter area ====================-->
    <div class="newsletter-area newsletter-area-bg bg-img" data-bg="<?php echo base_url() ?>assets/img/backgrounds/newsletter-bg.jpg">
    ...
    <!--====================  footer area ====================-->
    <div class="footer-area bg-img space__inner--ry120" data-bg="<?php echo base_url() ?>assets/img/backgrounds/footer-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-widget">
                        <div class="footer-widget__logo space__bottom--40">
                            <a href="index.html">
                                <img src="<?php echo base_url() ?>assets/img/wp-white-resize.png" class="img-fluid" style="width: 200px; height: auto;" alt="">
                            </a>
                        </div>
    ...
    <!-- copyright text -->
    <div class="copyright-area background-color--deep-dark space__inner--y30" style="background-color: rgba(1, 48, 166, 0.9);">
        <div class="container">
            <div class="row">
    ...
    <!-- Waypoint JS -->
    <script src="<?php echo base_url() ?>assets/js/plugins/waypoint.min.js"></script>
    <!-- Justified Gallery JS -->
    <script src="<?php echo base_url() ?>assets/js/plugins/justifiedGallery.min.js"></script>
    <!-- Image Loaded JS -->
    <script src="<?php echo base_url() ?>assets/js/plugins/imageloaded.min.js"></script>
    <!-- Maosnry JS -->
    <script src="<?php echo base_url() ?>assets/js/plugins/masonry.min.js"></script>
    <!-- Light Gallery JS -->
    <script src="<?php echo base_url() ?>assets/js/plugins/light-gallery.min.js"></script>
    <!-- Mailchimp JS -->
    <script src="<?php echo base_url() ?>assets/js/plugins/mailchimp-ajax-submit.min.js"></script>
