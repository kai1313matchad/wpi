                                    ...
                                    <div class="service-grid-item__image">
                                        <div class="service-grid-item__image-wrapper">
                                            <a href="service-details.html">
                                                <img src="<?php echo base_url() ?>assets/img/service/service-1-m.jpg" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="icon">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="service-grid-item">
                                    <div class="service-grid-item__image">
                                        <div class="service-grid-item__image-wrapper">
                                            <a href="service-details.html">
                                                <img src="<?php echo base_url() ?>assets/img/service/service-2-m.jpg" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="icon">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="service-grid-item">
                                    <div class="service-grid-item__image">
                                        <div class="service-grid-item__image-wrapper">
                                            <a href="service-details.html">
                                                <img src="<?php echo base_url() ?>assets/img/service/service-3-m.jpg" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="icon">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="service-grid-item">
                                    <div class="service-grid-item__image">
                                        <div class="service-grid-item__image-wrapper">
                                            <a href="service-details.html">
                                                <img src="<?php echo base_url() ?>assets/img/service/service-4-m.jpg" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="icon">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="service-grid-item">
                                    <div class="service-grid-item__image">
                                        <div class="service-grid-item__image-wrapper">
                                            <a href="service-details.html">
                                                <img src="<?php echo base_url() ?>assets/img/service/service-5-m.jpg" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="icon">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="service-grid-item">
                                    <div class="service-grid-item__image">
                                        <div class="service-grid-item__image-wrapper">
                                            <a href="service-details.html">
                                                <img src="<?php echo base_url() ?>assets/img/service/service-6-m.jpg" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="icon">
