                    ...
                    <div class="project-item-wrapper space__bottom--m40">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="single-project-wrapper single-project-wrapper--reduced-abs">
                                    <a class="single-project-item p-0" href="project-details.html">
                                        <img src="<?php echo base_url() ?>assets/img/projects/project1-m.jpg" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="single-project-wrapper single-project-wrapper--reduced-abs">
                                    <a class="single-project-item p-0" href="project-details.html">
                                        <img src="<?php echo base_url() ?>assets/img/projects/project2-m.jpg" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="single-project-wrapper single-project-wrapper--reduced-abs">
                                    <a class="single-project-item p-0" href="project-details.html">
                                        <img src="<?php echo base_url() ?>assets/img/projects/project3-m.jpg" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="single-project-wrapper single-project-wrapper--reduced-abs">
                                    <a class="single-project-item p-0" href="project-details.html">
                                        <img src="<?php echo base_url() ?>assets/img/projects/project4-m.jpg" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="single-project-wrapper single-project-wrapper--reduced-abs">
                                    <a class="single-project-item p-0" href="project-details.html">
                                        <img src="<?php echo base_url() ?>assets/img/projects/project5-m.jpg" class="img-fluid" alt="">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 space__bottom--40">
                                <div class="single-project-wrapper single-project-wrapper--reduced-abs">
                                    <a class="single-project-item p-0" href="project-details.html">
                                        <img src="<?php echo base_url() ?>assets/img/projects/project6-m.jpg" class="img-fluid" alt="">
